...
document.getElementById('resume-form')?.addEventListener('submit', function(event) {
    ...
    // Inject generated resume into the page
    const generatedResumeElement = document.getElementById('generated-resume') as HTMLDivElement;
    generatedResumeElement.innerHTML = generatedResume;
